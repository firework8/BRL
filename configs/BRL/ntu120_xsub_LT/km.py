model = dict(
    ...
    cls_head=dict(type='MixCBHead', num_classes=120, in_channels=256))
...
train_pipeline = [
    ...
    dict(type='GenSkeFeat', dataset='nturgb+d', feats=['km']),
...
data = dict(
    ...
    train=dict(
        ...
        times=5,
        num_classes=120,
        data_list_path='./data/NTU120_LT/NTU120_xsub_exp_'+imb_factor+'.txt',
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn_LT/ntu120_xsub_LT/km'
